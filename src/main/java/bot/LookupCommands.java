...
implements CommandExecutor{
	...
	public String readData(){
		...
		try {
			...
			try(BufferedReader br = new BufferedReader(new InputStreamReader(new URL("https://raw.githubusercontent.com/Wrzlprnft/EndlessSky-Discord-Bot/data/dataFileNames.txt").openStream()))) {
